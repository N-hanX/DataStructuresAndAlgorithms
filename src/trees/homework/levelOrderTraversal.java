...
//    currentRoot.left_ptr.label = 1;
//    currentRoot = currentRoot.left_ptr;
//
//    currentRoot.right_ptr = new TreeNode();
//    currentRoot.right_ptr.label = 2;
//    currentRoot = currentRoot.right_ptr;
//
//    currentRoot.left_ptr = new TreeNode();
//    currentRoot.left_ptr.label = 4;
//    currentRoot = currentRoot.left_ptr;
//
//    currentRoot.right_ptr = new TreeNode();
//    currentRoot.right_ptr.label = 3;
