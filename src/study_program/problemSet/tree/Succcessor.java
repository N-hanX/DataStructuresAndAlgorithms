...
public class Succcessor {
    public static void main(String[] args) {
        ...
        Integer successor1 = getSuccessor(node44, node88);
        Integer successor2 = getSuccessor(node44, node82);
        Integer successor3 = getSuccessor(node44, node29);
        Integer successor4 = getSuccessor(node44, node32);
        Integer successor5 = getSuccessor(node44, node76);
        Integer successor6 = getSuccessor(node44, node44);
        Integer successor7 = getSuccessor(node44, node97);

        int a = 4;
    }

    public static Integer getSuccessor(BinaryTreeNode root, BinaryTreeNode key){
        ...
        if(curr != null && curr.right != null){ // demek ki saginda
            curr = curr.right;
